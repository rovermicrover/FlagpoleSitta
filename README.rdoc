...
On a project I was doing thing like the OP was, which of course has a chance of failure if between the controller and the view the cache expires or is deleted.
